...
return [
    'tenant_connection_name' => 'tenant_content',

     'tenant_database_switch' => [
        'tenant_connections' => [
            'tenant_credentials',
            'tenant_content',
        ],
        
        'switch_tenant_database' => function (Tenant $tenant, string $connectionName) {
            $databaseName = match($connectionName) {
                'tenant_credentials' => 'tenant_' . $tenant->id . '_credentials',
                'tenant_content' => 'tenant_' . $tenant->id . '_content',
                default => null,
            };
            ...
            if ($databaseName) {
                ...
                app('db')->reconnect($connectionName);
            }
        },
    ],
    /*
    ...
    /*
     * These  will be performed when switching tenants.
     *
     * A valid task is any class that implements Spatie\Multitenancy\Tasks\SwitchTenantTask
     */
    'switch_tenant_tasks' => [
        // \Spatie\Multitenancy\Tasks\PrefixCacheTask::class,
        App\Tasks\SwitchMultiDatabaseTask::class,
    ],
     ...
     */
    'tenant_database_connection_name' => 'tenant_credentials',

    /*
     * The connection name to reach the landlord database.
     */
    'landlord_database_connection_name' => 'nexa_admin',
